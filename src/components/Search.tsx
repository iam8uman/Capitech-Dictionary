...
interface SearchProps {
  onSearchResult: (result: any[]) => void;
  onSearchHistoryUpdate: (word: string) => void;
}

const Search: React.FC<SearchProps> = ({ onSearchResult, onSearchHistoryUpdate }) => {
  const [searchTerm, setSearchTerm] = useState<string>('');
  ...
  const submitData = async () => {
    ...
    // Update the search result and search history
    onSearchResult(data);
    onSearchHistoryUpdate(searchTerm);
